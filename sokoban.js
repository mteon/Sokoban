$(document).ready(function () {
    ...
    function Sokoban () {
        ...
        this.initTable = function (obj, lvl) {
            ...
            $('#game').empty(); // Effacement de la div game
            ...
            for (let ob of obj.cells) {
                this.tableGrid[i] = []; // Initialisation du tableau
                let tr = $('<tr />').appendTo(table); // Ajout des lignes
